...
<Image
  src={image1}
  alt="composición con vinilo, portada ilustrada y una pantalla mostrando la onda sonora; estilo editorial, colores cálidos y contraste."
/>
...
<Image
  src={image2}
  alt="tablero con perfiles de músicos, portadas inspiradoras y notas de afinidad; estilo de investigación visual."
/>
...
<Image
  src={image3}
  alt="grid con mini‑mockups de cada formato (portada, visuales, zine, poster, vinilo); estilo profesional y variado."
/>
...
<Image
  src={image4}
  alt="documento de brief con secciones claras y ejemplos adjuntos; estilo editorial."
/>
...
<Image
  src={image5}
  alt="diagrama de flujo con las 6 etapas y ejemplos visuales en cada paso; estilo infográfico."
/>
...
<Image
  src={image6}
  alt="ejemplo de contrato simple con secciones de licencia y pagos; estilo profesional."
/>
...
<Image
  src={image7}
  alt="mockup de pantalla de concierto con visuales en loop y capa de control visible; estilo nocturno y cinematográfico."
/>
...
<Image
  src={image8}
  alt="calendar de lanzamiento con contenidos por canal y ejemplos de assets; estilo UI."
/>
...
<Image
  src={image9}
  alt="tabla visual con los tres paquetes y elementos incluidos; estilo comercial."
/>
...
<Image
  src={image10}
  alt="mockup web de entrada de portafolio con video embed y galería de proceso; estilo UI editorial."
/>
...
<Image
  src={image11}
  alt="estudio compartido con equipo de trabajo, bocetos pegados en la pared y monitores mostrando ondas y arte finalizado; estilo semi‑realista, atmósfera creativa."
/>
