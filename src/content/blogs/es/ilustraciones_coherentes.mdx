...
<Image
  src={image1}
  alt="moodboard conceptual con palabras clave, referencias fotográficas y anotaciones a mano; estilo collage editorial."
/>
...
<Image
  src={image2}
  alt="ficha técnica visual con formato, paleta de 4–5 colores y ejemplos de texturas; estilo limpio tipo estudio."
/>
...
<Image
  src={image3}
  alt="cronograma visual con fases y tiempos por pieza; estilo infográfico."
/>
...
<Image
  src={image4}
  alt="tres mini‑mockups mostrando las variaciones propuestas (cercano, amplio, abstracto); estilo editorial."
/>
...
<Image
  src={image5}
  alt="misma ilustración vista en tres tamaños (pantalla completa, vista a distancia en pared, thumbnail) con notas sobre legibilidad; estilo instructivo."
/>
...
<Image
  src={image6}
  alt="galería de proceso con boceto, estudio de color y versión final para una pieza; estilo mixto."
/>
...
<Image
  src={image7}
  alt="pruebas de impresión sobre distintos papeles con close‑ups de textura; estilo fotográfico profesional."
/>
...
<Image
  src={image8}
  alt="plano de montaje de sala con distribución de obras y notas de iluminación; estilo arquitectónico minimalista."
/>
...
<Image
  src={image9}
  alt="mockup de catálogo con portada, índice y página de proceso; estilo editorial elegante."
/>
...
<Image
  src={image10}
  alt="ficha de venta de obra con título, tamaño, técnica y precio; estilo profesional y ordenado."
/>
...
<Image
  src={image11}
  alt="tablero de evaluación con métricas, notas y fotos de la sala; estilo workshop."
/>
...
<Image
  src={image12}
  alt="vista panorámica de la sala con la serie completa colgada y visitantes interactuando; estilo semi‑realista, atmósfera contemplativa."
/>
