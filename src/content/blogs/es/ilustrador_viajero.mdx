...
<Image
  src={image1}
  alt="mochila abierta con elementos organizados: cuaderno, tablet, cámara, cargadores y funda impermeable; estilo fotográfico cálido y práctico."
/>
...
<Image
  src={image2}
  alt="cuaderno con thumbnails, fotos impresas y una lista de notas rápidas en una mesa de café; estilo íntimo y documental."
/>
...
<Image
  src={image3}
  alt="siete mini‑ilustraciones A5 dispuestas en fila, cada una con paleta distinta; estilo editorial y colorido."
/>
...
<Image
  src={image4}
  alt="pantalla de ordenador con carpeta organizada por días y miniaturas, cuaderno físico y tazas de café; estilo realista y ordenado."
/>
...
<Image
  src={image5}
  alt="mockups de print enmarcado, zine abierto y mockup de página editorial; estilo comercial y elegante."
/>
...
<Image
  src={image6}
  alt="mockup web de entrada de portafolio con galería y texto de proyecto; estilo UI minimalista."
/>
...
<Image
  src={image7}
  alt="ilustración que muestre buenas prácticas: pedir permiso, dejar espacio y tomar nota; estilo didáctico y humano."
/>
...
<Image
  src={image8}
  alt="mesa de trabajo al volver con mapas, cuadernos, fotos impresas y la primera ilustración terminada en el centro; estilo cálido y narrativo."
/>
