...
<Image
  src={image1}
  alt="comparative table with three identical mini-illustrations applied to emotionally different palettes (warm, cool, high-contrast); editorial style, light colors and visible labels."
/>
...
<Image
  src={image2}
  alt="vertical palette with 5 swatches; each swatch has a short note, clean studio design style.."
/>
...
<Image
  src={image3}
  alt="csame illustration reproduced in three sizes (thumbnail, screen, print) with notes on legibility; instructive clear style."
/>
...
<Image
  src={image4}
  alt="side-by-side comparison of the same composition with handmade textures and clean treatment; mixed style, high texture detail."
/>
...
<Image
  src={image5}
  alt="five horizontal palette cards with mini-application mockup (e.g., cover or reduced poster) and brief note; editorial UI style."
/>
...
<Image
  src={image6}
  alt="board with the three exercises described, showing examples of mini-results; creative workshop style."
/>
...
<Image
  src={image7}
  alt="illustration with three warning icons and visual examples of each error; didactic clear style."
/>
...
Some tools make rapid testing and clean exports easier. Use palette generators, plugins to extract colors from images, and build a personal swatch library that can be exported into your design software. Keep versions in sRGB for web and in the correct profile for print when applicable.

Suggested resources:

- Online palette generators.
- Color extraction plugins in illustration software.
- Personal libraries synced across devices.

<Image
  src={image9}
  alt="realistic-style mockup screenshot of digital palette and color extraction tools; visible interface."
/>
...
Mastery of color comes from deliberate practice and conscious decisions. Apply the framework and exercises from this guide over one week and you'll see visible progress in your color reading and the coherence of your pieces.

7-Day Action Plan:

- Day 1: Define 3 emotions you want to explore.
- Day 2: Gather 30 color references that represent them.
- Day 3: Choose 3 sketches and apply 3 different palettes to each.
- Day 4: Select one palette and remake a piece using only 3 colors.
- Day 5: Add textures and test clean/manual versions.
- Day 6: Validate with thumbnail and usage mockup.
- Day 7: Document the process in a portfolio entry with swatches and intent notes.

<Image
  src={image10}
  alt="weekly calendar with tasks and illustrative mini-results; minimalist and colorful style."
/>
