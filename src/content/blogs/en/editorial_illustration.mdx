...
<Image
  src={image1}
  alt="series of mini mockups showing the same illustration applied to a column, a cover and a social post; editorial graphic style, clean and professional."
/>
...
<Image
  src={image2}
  alt="illustration of an email tray with an editorial brief open and handwritten notes with concept alternatives; realistic with graphic elements."
/>
...
<Image
  src={image3}
  alt="three conceptual vignettes showing the previous metaphors in editorial style; sober palette and clear composition."
/>
...
<Image
  src={image4}
  alt="PDF mockup with numbered thumbnails and short text notes; clean professional style."
/>
...
<Image
  src={image5}
  alt="visual table with common sizes (column, half page, cover) and crop examples; instructive clear style."
/>
...
<Image
  src={image6}
  alt="screenshot of a PSD file organized with named colored layers; realistic professional style."
/>
...
<Image
  src={image7}
  alt="layout mockup with areas marked for headline, subtitle and body; editorial style, clear lines."
/>
...
<Image
  src={image8}
  alt="organized folder on screen with files named as in the example; realistic workspace style."
/>
...
<Image
  src={image9}
  alt="quotation document with sections for usage, times and prices; professional minimalist style."
/>
...
<Image
  src={image10}
  alt="editorial portfolio entry mockup with all elements above; elegant UI style."
/>
...
<Image
  src={image11}
  alt="illustration with five icons representing each mistake; didactic clear style."
/>
...
<Image
  src={image12}
  alt="board with articles, thumbnails and the final version of an exercise; creative workshop style."
/>
...
<Image
  src={image13}
  alt="final illustration mocked on a magazine cover on a worktable; semi-realistic editorial layout style."
/>
