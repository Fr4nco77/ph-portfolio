...
<Image
  src={image1}
  alt="table with printed brief, product samples and handwritten notes highlighting audience, channel and message; realistic professional style."
/>
...
<Image
  src={image2}
  alt="three mini mockups of labels with different concepts (literal, symbolic, abstract) on the same package template; editorial style."
/>
...
<Image
  src={image3}
  alt="label mockup with hierarchy layers marked (brand, name, claim, legal data), annotations on sizes and contrasts; instructive style."
/>
...
<Image
  src={image4}
  alt="card with swatches, intention notes per color and mini mockup applying the palette to the label; clean studio style."
/>
...
<Image
  src={image5}
  alt="side-by-side comparison of the same illustration in vector, raster and hybrid, with notes on advantages and limitations; technical style."
/>
...
<Image
  src={image6}
  alt="screenshot of PSD/AI file with layers and bleed guides visible; professional style."
/>
...
<Image
  src={image7}
  alt="photo of physical label and box proofs, with notes and a magnifying glass; realistic style."
/>
...
<Image
  src={image8}
  alt="technical dieline plan with marked areas and example label adapted to folding; architectural technical style."
/>
...
<Image
  src={image9}
  alt="PDF mockup with the proposal structure shown on screen; professional elegant style."
/>
...
<Image
  src={image10}
  alt="packaging trends moodboard with standout examples and opportunity notes; collage editorial style."
/>
...
<Image
  src={image11}
  alt="organized delivery folder on screen with files listed; clean professional style."
/>
...
<Image
  src={image12}
  alt="shelf with coherently illustrated products on a sales line, commercial lighting and visible label; semi-realistic display style."
/>
