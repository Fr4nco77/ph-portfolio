...
<Image
  src={image1}
  alt="minimalist diagram with three principles (Focus, Boundaries, Metrics) represented by icons and brief notes; clean editorial style."
/>
...
<Image
  src={image2}
  alt="aerial view of a desk with a weekly planner open, tablet showing a calendar and a cup of coffee; semi-realistic warm light style."
/>
...
<Image
  src={image3}
  alt="visual decision cards (palette, composition, microdetails) arranged on a table; graphic functional style."
/>
...
<Image
  src={image4}
  alt="calendar notification on screen showing block 'Do Not Disturb: creative work' and an email with an approved brief; realistic professional style."
/>
...
<Image
  src={image5}
  alt="screen with a tools board (presets, actions, shortcuts) and a sync cloud; professional UI style."
/>
...
<Image
  src={image6}
  alt="monthly calendar with daily tasks and visual examples; minimalist colorful style."
/>
...
<Image
  src={image7}
  alt="simple dashboard with 4 metrics charts (productive hours, finished pieces, minutes of daily sketching, weekly admin tasks); clear infographic style."
/>
...
<Image
  src={image8}
  alt="studio at dusk with productivity elements visible (planner, timer, tablet) and a finished illustration on the screen; semi-realistic tranquil atmosphere."
/>
