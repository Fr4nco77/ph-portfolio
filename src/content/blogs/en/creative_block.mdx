...
<Image
  src={image1}
  alt="handwritten list in a notebook with three columns (avoid starting; struggle to progress; produce but unsatisfied) and ticks; intimate realistic style."
/>
...
<Image
  src={image2}
  alt="hand drawing a thumbnail with an hourglass next to it; dynamic close style."
/>
...
<Image
  src={image3}
  alt="visual timeline of a 120-minute session with colored blocks and short objectives; clean functional style."
/>
...
<Image
  src={image4}
  alt="weekly calendar with blocks marked: sketching, deep work, rest, experimentation; minimalist style."
/>
...
<Image
  src={image5}
  alt="visual cards with palettes and compositions ready to choose; practical style."
/>
...
<Image
  src={image6}
  alt="screenshot of a clear feedback message with intention and 2 questions; human direct style."
/>
...
<Image
  src={image7}
  alt="7-day calendar with a task per day and tracking boxes; functional style."
/>
...
<Image
  src={image8}
  alt="studio with several sketch sheets, an illustration in progress and a cup of tea; warm realistic style."
/>
