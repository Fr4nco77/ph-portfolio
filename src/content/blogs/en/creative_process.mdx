...
<Image
  src={image1}
  alt="visual diagram of the creative process in four phases (inspiration, sketch, production, publication) with minimalist icons and work samples; modern editorial style, neutral colors with accents."
/>
...
<Image
  src={image2}
  alt="inspiration collages with photos, clippings, palettes, and handwritten notes; mixed editorial collage style, visible textures."
/>
...
<Image
  src={image3}
  alt="open notebook with a grid of quick thumbnails, one marked with a red circle; graphic style, textured paper and loose strokes."
/>
...
<Image
  src={image4}
  alt="color board with swatches, notes on sensations associated with each swatch, and sketch thumbnail applied to each palette; clean style, studio-like design."
/>
...
<Image
  src={image5}
  alt="illustration software screen showing layers and steps, drawing tablet and hand on stylus; realistic style with studio lighting."
/>
...
<Image
  src={image6}
  alt="close-up of an illustration showing textures and small narrative elements; mixed high-resolution style."
/>
...
<Image
  src={image7}
  alt="person taking notes in front of a screen with the illustration; collaborative warm human style."
/>
...
<Image
  src={image8}
  alt="web portfolio mockup with process gallery and notes, elegant minimalist UI style."
/>
...
<Image
  src={image9}
  alt="creative weekly calendar with time blocks and stickers, minimalist colorful style."
/>
...
<Image
  src={image10}
  alt="visual checklist with the 21 actions in attractive design; editorial style, contrasting colors."
/>
...
<Image
  src={image11}
  alt="illustrator's studio with the finished piece in the center, tools around and a window with late afternoon light; semi-realistic contemplative atmosphere."
/>
