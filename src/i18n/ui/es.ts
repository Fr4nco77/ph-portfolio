export default {
  ...
  footer: {
    copyright: "®Copyright 2025 PH. Todos los derechos reservados.",
  },
  cta: {
  ...
  main: {
    ...
    hero: {
      h1: "Captura cada movimiento — Portafolio de Ilustración Digital",
      title1: "CAPTURA",
      title2: "CADA",
      title3: "MOVIMIENTO",
      subtitle: "Artista Visual.",
      tags: "Narrativa • Diseño de Personajes • Ilustración • Arte Conceptual",
    },
    recentProjects: {
